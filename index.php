...
// data instructor
$queryIntructor = mysqli_query($connection, "SELECT * FROM instructors ORDER BY id DESC LIMIT 4");
...
<body>
  ...
  <div class="container-xxl py-5">
    <div class="container">
      ...
      <div class="row g-4">
        <?php while($rowInstructor = mysqli_fetch_assoc($queryIntructor)) : ?>
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="team-item bg-light">
            <div class="overflow-hidden">
              <img class="img-fluid" src="admin/upload/<?php echo $rowInstructor['photo'] ?>" alt="">
            </div>
            <div class="position-relative d-flex justify-content-center" style="margin-top: -23px;">
              <div class="bg-light d-flex justify-content-center pt-2 px-1">
                <a class="btn btn-sm-square btn-primary mx-1" href="<?php echo $rowInstructor['facebook_link'] ?>"><i
                    class="fab fa-facebook-f"></i></a>
                <a class="btn btn-sm-square btn-primary mx-1" href="<?php echo $rowInstructor['instagram_link'] ?>"><i
                    class="fab fa-twitter"></i></a>
                <a class="btn btn-sm-square btn-primary mx-1" href="<?php echo $rowInstructor['twitter_link'] ?>"><i
                    class="fab fa-instagram"></i></a>
              </div>
            </div>
            <div class="text-center p-4">
              <h5 class="mb-0"><?php echo $rowInstructor['instructor_name'] ?></h5>
              <small><?php echo $rowInstructor['instructor_major'] ?></small>
            </div>
          </div>
        </div>
        <?php endwhile ?>
